...
*/    //-----------------------------------------------------------------------------    
   //==============================================================================
       ...
       if(keys[VK_F8])
       {
             ...
             outSettings << "var         shinyPlasticFireBall_ATTENUATION      =  " << shinyPlasticFireBall_ATTENUATION << ";\n\n";
            
             outSettings << "var         refraction_SHININESS                  =  " << refraction_SHININESS << ";\n";             
             
             outSettings << "var         refraction_ATTENUATION                =  " << refraction_ATTENUATION << ";\n\n\n";             
